  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Sora:wght@300;400;500;600;700;800&family=Manrope:wght@300;400;500;600;700&family=EB+Garamond:ital,wght@0,400;0,500;1,400&display=swap"
          rel="stylesheet"
        />
      </head>
      <body className="font-body antialiased" style={{ backgroundColor: "#050505", color: "#F5F1EA" }}>
        <Navbar />
        <main>{children}</main>
        <Footer />
      </body>
